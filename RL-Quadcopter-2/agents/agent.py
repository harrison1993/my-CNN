...
class DDPG():
    ...
    def __init__(self, task):
        ...
        # Noise process   self.theta * (self.mu - x) + self.sigma * np.random.randn(len(x))
        ...
        self.score = 0   # Score tracker and learning parameters
...
class Critic:
    ...
    def build_model(self):
        ...
        optimizer = optimizers.Adam(0.00005)#0.0001
